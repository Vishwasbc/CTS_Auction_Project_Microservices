 ...
 * // layers
 * 
 * @Pointcut("execution(* com.userservice..*(..))") public void
 * applicationMethods() { }
 * 
 * // Before method execution
 * 
 * @Before("applicationMethods()") public void logBefore(JoinPoint joinPoint) {
 ...
 * 
 * @After("applicationMethods()") public void logAfter(JoinPoint joinPoint) {
 * logger.info("Method executed: {}", joinPoint.getSignature()); }
 * 
 * // After method throws an exception
 * 
 * @AfterThrowing(pointcut = "applicationMethods()", throwing = "ex") public
 * void logAfterThrowing(JoinPoint joinPoint, Throwable ex) {
 * logger.error("Exception in {} with cause = {}", joinPoint.getSignature(),
 * ex.getMessage()); } }
 */